...
class Photo(models.Model):
    ...
    exif_make = models.CharField(max_length=30, null=True, default="null")
    ...
    location_name = models.CharField(max_length=30, null=True, default="null")
    ...
    user_display_name = models.CharField(max_length=50, null=False)
