...
"""
    ...
    Lexers for various templates engines' markup.
...
class SmartyLexer(RegexLexer):
    """
    Generic `Smarty <http://smarty.php.net/>`_ templates lexer.
...
class VelocityLexer(RegexLexer):
    """
    Generic `Velocity <http://velocity.apache.org/>`_ templates lexer.
...
class DjangoLexer(RegexLexer):
    ...
    and `jinja <http://wsgiarea.pocoo.org/jinja/>`_ templates lexer.
...
class HandlebarsLexer(RegexLexer):
    """
    Generic `handlebars <http://handlebarsjs.com/>` templates lexer.

    Highlights only the Handlebars templates tags (stuff between `{{` and `}}`).
...
class HandlebarsHtmlLexer(DelegatingLexer):
    ...
    mimetypes = ['text/html+handlebars', 'text/x-handlebars-templates']
...
class TwigLexer(RegexLexer):
    """
    `Twig <http://twig.sensiolabs.org/>`_ templates lexer.
