...
class RacketLexer(RegexLexer):
    ...
    _keywords = (
        ...
        'for-templates', 'for/and', 'for/first', 'for/fold', 'for/fold/derived',
    ...
    _builtins = (
        ...
        'free-templates-identifier=?', 'free-transformer-identifier=?',
        ...
        'identifier-templates-binding', 'identifier-transformer-binding',
