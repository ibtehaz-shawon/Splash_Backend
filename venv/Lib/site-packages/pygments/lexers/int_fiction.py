...
class Inform7Lexer(RegexLexer):
    ...
    for level in token_variants:
        ...
        # Inform 7 can include snippets of Inform 6 templates language,
        # so all of Inform6Lexer's states are copied here, with
        # modifications to account for templates syntax. Inform7Lexer's
        # own states begin with '+' to avoid name conflicts. Some of
        # Inform6Lexer's states begin with '_': these are not modified.
        # They deal with templates syntax either by including modified
    ...
    tokens = {
        ...
        'main/basic': [
            ...
            (r'(new)(%s+(?=(?:function|method)\b))' % _ws,
             bygroups(Keyword.Reserved, using(this, state='whitespace'))),
            (r'(object)(%s+)(templates\b)' % _ws,
             bygroups(Keyword.Reserved, using(this, state='whitespace'),
                      Keyword.Reserved), ('#pop', 'templates')),
            (r'(string)(%s+)(templates\b)' % _ws,
            ...
            (r'templates\b', Keyword.Reserved, ('#pop', 'templates')),
            # Operators
