...
LEXERS = {
    ...
    'GosuTemplateLexer': ('pygments.lexers.jvm', 'Gosu Template', ('gst',), ('*.gst',), ('text/x-gosu-templates',)),
    ...
    'HandlebarsHtmlLexer': ('pygments.lexers.templates', 'HTML+Handlebars', ('html+handlebars',), ('*.handlebars', '*.hbs'), ('text/html+handlebars', 'text/x-handlebars-templates')),
    ...
    'Inform6TemplateLexer': ('pygments.lexers.int_fiction', 'Inform 6 templates', ('i6t',), ('*.i6t',), ()),
