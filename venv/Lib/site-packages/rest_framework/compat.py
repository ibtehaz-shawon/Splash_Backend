...
def template_render(template, context=None, request=None):
    ...
    https://github.com/django/django/blob/1.9/django/templates/backends/django.py#L82-L84

    :param template: Template instance
    :param context: dict
    :param request: Request instance
    :return: rendered templates as SafeText instance
    """
    ...
    # backends templates, e.g. django.templates.backends.django.Template
    else:
